...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">31. Uredjaj za davanje zvučnih znakova na motornom vozilu mora biti ugradjen i izveden kao uredjaj koji daje:</p></br>
				...
				<p class="par">dvotonske zvuke promenljivog intenziteta</p></br>
			</div>
		</div>
		<div class="col-sm-2"></div>
</div></br>

...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">27. Ispred kolskog ulaza u zgradu, dvorište ili garažu, vozač ne sme da:</p></br>
				<span class="glyphicon glyphicon-ok s27 hider"></span><label class="radio-inline"><input type="radio" id="m27" name="quest27">a)</label>
				<p class="par">parkira svoje vozilo</p></br>
				...
				<p class="par">zaustavi, niti parkira svoje vozilo</p></br>
			</div>
		</div>
		<div class="col-sm-2"></div>
</div></br>

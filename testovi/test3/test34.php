...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">34. Ukoliko postoji gubitak svesti(nesvest) sa očuvanom funkcijom rada srca, spoljašnja masaža srca se:</p></br>
				...
				<p class="par">primenjuje delimično</p></br>
			</div>
		</div>
		<div class="col-sm-2"></div>
</div></br>

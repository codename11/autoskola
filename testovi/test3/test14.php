...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">14. Prema saobraćajnom znaku na slici, vozač sme da parkira svoje vozilo:</p></br>

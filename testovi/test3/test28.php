...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">28. Vozač vozila na motorni pogon mora na svom vozilu po magli imati upaljena:</p></br>
				...
				<p class="par">velika svetla i svetla za maglu istovremeno</p></br>
			</div>
		</div>
		<div class="col-sm-2"></div>
</div></br>

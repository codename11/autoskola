...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">1. Vozač putničkog automobila pretiče drugi putnički automobil u raskrsnici gde mu je preticanje:</p></br>
				<img src="images\test\test21.jpg" id="slika"></br>

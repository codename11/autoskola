...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">21. Na mesto na kome bi vozilo zaklanjalo postavljeni saobraćajni znak ili uredjaj za davanje svetlosnih saobraćajnih znakova, zabranjeno je:</p></br>

...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">37. Povredjeni ima potres mozga i u nesvesti je. Potrebno je staviti ga u:</p></br>

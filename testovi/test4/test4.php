...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">4. Kada se kreće auto-putem vozač autobusa koji pored sedišta ima i odredjena mesta za stajanje, ne sme se kretati brzinom većom od:</p></br>
				<span class="glyphicon glyphicon-remove s4 hider"></span><label class="radio-inline"><input type="radio" id="mx4" name="quest4">a)</label>
				<p class="par">120km/h</p></br>

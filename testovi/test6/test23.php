...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">23. Javni prevoz lica u linijskom drumskom saobraćaju je prevoz koji se vrši:</p></br>
				<span class="glyphicon glyphicon-ok s23 hider"></span><label class="radio-inline"><input type="radio" id="m23" name="quest23">a)</label>
				<p class="par">na odredjenim relacijama, po unapred utvrdjenom redu vožnje i za koji su cene i drugi uslovi prevoza odredjeni unapred odredjenom tarifom</p></br>
				...
				<p class="par">radi zadovoljenja sopstvenih potreba imaoca motornih vozila</p></br>
			</div>
		</div>
		<div class="col-sm-2"></div>
	</div></br>

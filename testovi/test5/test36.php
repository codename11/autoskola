...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">36. Kod istovremenog prestanka rada srca i disanja(prividna smrt) primenjuje se:</p></br>
				...
				<p class="par">veštačko disanje</p></br>

...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">23. Na prednjem sedištu, lice koje je pod uticajem alkohola:</p></br>
				...
				<p class="par">sme se prevoziti</p></br>

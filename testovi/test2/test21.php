...
<div class="row form-group">
		...
		<div class="col-sm-8">
			<div class="tst">
				<p class="par">21. Vozač ne sme da zaustavi ili parkira vozilo na raskrsnici i na udaljenosti od najbliže ivice poprečnog kolovoza manjoj od:</p></br>
